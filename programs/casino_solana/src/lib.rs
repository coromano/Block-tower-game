...
// Seguridad: Validar que los fondos siempre vayan a esta cuenta y no a una arbitraria proporcionada por el usuario
const TESORERIA_WALLET: Pubkey = pubkey!("GmCD67exiNMBEdNe4F2c39FHWwpaU6nn3Jgez6DbXdQh");
...
pub struct ComprarBloque<'info> {
    ...
    #[account(mut)]
    pub user: Signer<'info>, 
    /// CHECK: Tesorería del juego (se valida que el address sea correcto)
